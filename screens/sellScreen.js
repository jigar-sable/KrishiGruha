...
const sellScreen = ({route,navigation}) => {
    ...
    const formHandler = () =>{
        ...
        var config = {
        method: 'post',
        url: 'https://backendrn.herokuapp.com/api/sellItem',
        headers: { 
    ...
    return (
        <View style={styles.mainContainer} >
            ...
            <View style={styles.formContainer}>
                ...
                <Button onPress={()=>formHandler()} buttonStyle={{backgroundColor:'green',borderRadius:30,marginLeft:9,marginRight:9}} title="SELL"/>
            </View>
            </ScrollView>
        </View>
